...
export const PERSONAS: Persona[] = [
  {
    ...
    routes: ['/', '/workspace', '/tickets', '/customers', '/knowledge-base', '/portal', '/channels', '/reports', '/automation', '/organisation', '/admin'],
    avatar: 'AD',
    accent: '#6D28D9',
  },
  {
    ...
    routes: ['/', '/workspace', '/tickets', '/customers', '/knowledge-base', '/channels', '/reports', '/automation'],
    avatar: 'MG',
    accent: '#0E7490',
  },
  {
    ...
    routes: ['/', '/workspace', '/tickets', '/customers', '/knowledge-base', '/channels'],
    avatar: 'AG',
    accent: '#B45309',
  },
  {
